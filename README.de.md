...
| [Codex CLI](https://github.com/openai/codex) | `codex` | `json-event-stream` + `codex` Parser | `codex exec --json --skip-git-repo-check --sandbox workspace-write [-C cwd] [--model …] [-c model_reasoning_effort=…] -` (Prompt über stdin) |
