...
export const th: Dict = {
  ...
  'entry.navNewProject': 'โครงการใหม่',
  'entry.navHome': 'หน้าหลัก',
  'entry.navProjects': 'โครงการ',
  'entry.navDesignSystems': 'ระบบการออกแบบ',
  'entry.navAutomations': 'ระบบอัตโนมัติ',
  'entry.navPlugins': 'ปลั๊กอิน',
  'entry.navIntegrations': 'การผสานรวม',
